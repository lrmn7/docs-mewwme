...
<Image img={require('../../static/img/docs/features/song-features.png')} className="custom-image" />
...
<Image img={require('../../static/img/docs/features/lyrics.png')} className="custom-image" />
...
<Image img={require('../../static/img/docs/playing-a-song/searchsong.png')} className="custom-image" />
...
<Image img={require('../../static/img/docs/features/filters.png')} className="custom-image" />
...
<Image img={require('../../static/img/docs/features/queue.png')} className="custom-image" />
