...
<Image img={require('../../static/img/docs/features/song-features.png')} width="60%" height="60%" />
...
<Image img={require('../../static/img/docs/features/lyrics.png')} width="60%" height="60%" />
...
<Image img={require('../../static/img/docs/playing-a-song/searchsong.png')} width="60%" height="60%" />
...
<Image img={require('../../static/img/docs/features/filters.png')} width="60%" height="60%" />
...
<Image img={require('../../static/img/docs/features/queue.png')} width="60%" height="60%" />
