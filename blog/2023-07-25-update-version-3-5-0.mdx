---
title: Mewwme's V.3.5.0
authors: lrmn
tags: [mewwme, update, v.3.5.0]
description: "Introducing Mewwme's V.3.5.0! This update brings significant improvements and optimizations for a better user experience."
hide_table_of_contents: false
---

import Image from '@theme/IdealImage';

## Welcome to Mewwme's V.3.5.0!
...
- **Musicard Support Removal:** Removed support for musicard, with documentation implementation planned for later.
